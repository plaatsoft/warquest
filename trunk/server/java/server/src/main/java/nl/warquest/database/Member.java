...
public class Member  implements java.io.Serializable {
    ...
    public Member(String username, String password, String email, int emailValid, int notificationComment, int notificationAlliance, Date created, Date lastLogin, Date prevLogin, String ip, String browser, String platform, int autoLogin) {
